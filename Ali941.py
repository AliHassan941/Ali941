...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 Ali941.py')
...
def pilih_login():
    ...
    if peak =="":
        ...
        os.system('xdg-open  https://youtube.com/UCG8CSxk8KQMZuVfRhCa6FBw')
        Zeek()
def Zeek():
    os.system('clear')
    print logo1
...
def action():
    ...
    jalan("Note : ALI_CP  account Will Open after 7 days")
    print ''
    print """



\033[1;97mNice to meet you soon
\033[1;97mFb\033[1;97mALI HASSAN """
